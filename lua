getgenv().sethiddenproperty = getgenv().sethiddenproperty or function(ins, prop, val) pcall(function() ins[prop] = val end) end
...
v484:AddDiscordInvite({
    Name = "Legend Script | Channel",
    Description = "Follow to receive Update",
